    ...
    return (
                    <>
                        <nav className={navStyle.nav+' pb-4 pt-4'}>
                            <Button type="secondary" size="medium" extraClass={navStyle.nav+' text text_type_main-small p-5 mr-2'}>
                                <BurgerIcon type="primary" className='mr-2'/>
                                 <span>
                                    Конструктор
                                </span>
                            </Button>
                            <Button type="secondary" size="medium" extraClass={navStyle.nav+' text text_type_main-small p-5 mr-15'}>
                            ...
                            <Logo/>
                            <Button type="secondary" size="medium" extraClass={navStyle.nav+' text text_type_main-small p-5 ml-15'}>
